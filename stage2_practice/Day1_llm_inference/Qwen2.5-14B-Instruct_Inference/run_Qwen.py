...
model_path = "/data/pretrained_models/Qwen2.5-14B-Instruct"

output_dir = "outputs"
os.makedirs(output_dir, exist_ok=True)

md_path = os.path.join(output_dir, "Qwen_inference_results.md")
jsonl_path = os.path.join(output_dir, "Qwen_inference_results.jsonl")
fig_path = os.path.join(output_dir, "Qwen_generation_stats.png")

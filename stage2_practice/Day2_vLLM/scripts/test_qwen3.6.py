...
md_path = os.path.join(output_dir, "qwen3.6_output.md")
jsonl_path = os.path.join(output_dir, "qwen3.6_output.jsonl")
...
with open(md_path, "w", encoding="utf-8") as f:
    ...
    f.write("# Qwen3.6 vLLM Inference Experiment\n\n")
...
with open(jsonl_path, "w", encoding="utf-8") as jf:
    ...
    for prompt_id, prompt in enumerate(prompts, start=1):
        ...
        for cfg_id, cfg in enumerate(param_groups, start=1):
            ...
            generated_tokens = usage.completion_tokens if usage else None
